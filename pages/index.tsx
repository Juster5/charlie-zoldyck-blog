    ...
    <div className='home-page-container'>
      ...
      <div className='second-section'>
        <div className='second-title'>
          ...
          <p className='common-desc response-text pc-text'>Get the lowest fees, fastest transactions, powerful APIs, and more.</p>
          <p className='common-desc response-text mobile-text'>Lowest fees, world-class matching engine, powerful APIs and much more</p>
        </div>
        ...
        <div className="third-container">
            <div className="third-animation">
              {/* <picture className="okui-image-webp"> */}
                ...
                <img className="third-animation-img" src={activeImg} alt="One app. Unlimited possibilities.Lite" width="288" height="624" />
              {/* </picture> */}
            </div>
            <div className="third-body">
              ...
              <div className="tab-container">
                {
                  sectionFourItems.map((el, index)=>{
                    return (
                      <div key={index} className={`tab-item ${activeIndex === index ? 'active' : ''}`} onClick={()=>{
              ...
              <p className="common-desc">With margin and derivatives trading, powerful APIs and trading bots, you can trade like a pro on the go.</p>
            </div>
        </div>
      </section>
      ...
      <div className="fourth-section">
        <div className='fourth-title'>
          ...
          <p className='common-desc response-text pc-text'>From your first crypto trade to your first NFT purchase, you'll have us to guide you through the process. No stupid questions. No sleepless nights. Have confidence in your crypto.</p>
          <p className='common-desc response-text mobile-text'>Jump from trading, to DeFi, to NFTs all in one place.</p>
        </div>
        <div className='fourth-body'>
          ...
          />
          <img className="mobile-text" alt="With you every step of the wayFrom your first crypto trade to your first NFT purchase, you'll have us to guide you through the process. No stupid questions. No sleepless nights. Have confidence in your crypto." width="400" height="400" src="https://static.okx.com/cdn/assets/imgs/2210/602389EA3A7E31BD.gif"/>          
        </div>        
      </div>
